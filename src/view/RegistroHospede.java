...
public class RegistroHospede extends JFrame {
	...
	private HospedesController hospedecController;
	...
	public RegistroHospede(Reservas reserva) {
		hospedecController = new HospedesController();
		this.reserva = reserva;
		
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroHospede.class.getResource("/assets/imagens/lOGO-50PX.png")));
		...
		txtDataN.getCalendarButton().setIcon(new ImageIcon(RegistroHospede.class.getResource("/assets/imagens/icon-reservas.png")));
		...
		btnsalvar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				salvarRegistro();
				Sucesso sucesso = new Sucesso(hospede);
		...
		imageFundo.setIcon(new ImageIcon(RegistroHospede.class.getResource("/assets/imagens/registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHospede.class.getResource("/assets/imagens/Ha-100px.png")));
	}

	private void salvarRegistro(){
		hospede = new Hospedes(txtNome.getText(), txtSobrenome.getText(), txtDataN.getDate(), txtNacionalidade.getSelectedItem().toString(), txtTelefone.getText(), reserva.getId());
		this.hospedecController.registrarHospede(hospede);
	}
