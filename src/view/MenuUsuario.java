...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuUsuario.class.getResource("/assets/imagens/aH-40px.png")));
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(MenuUsuario.class.getResource("/assets/imagens/pessoas.png")));
		...
		panelMenu.add(logo);
		logo.setIcon(new ImageIcon(MenuUsuario.class.getResource("/assets/imagens/aH-150px.png")));
		...
		labelRegistro.setIcon(new ImageIcon(MenuUsuario.class.getResource("/assets/imagens/reservado.png")));
	    ...
	    String textoDescripcion = "<html><body>Sistema de reservas de hotéis. Controle e gerencie de forma <br> otimizada e fácil o fluxo de reservas e hóspedes do hotel</body></html>";
	    ...
	    JLabel labelDescricao_2 = new JLabel("- Registros de Reservas e Hóspedes");
	    ...
	    JLabel labelDescricao_3 = new JLabel("- Edição de Reservas e Hóspedes");
