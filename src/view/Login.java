...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/assets/imagens/img-hotel-login-.png")));
		...
		logo.setIcon(new ImageIcon(Login.class.getResource("/assets/imagens/lOGO-50PX.png")));
	...
	private boolean validarSenha(){
		...
		Usuarios usuario = new Usuarios(txtUsuario.getText(), senha);
		return this.usuarioController.validarSenha(usuario);
	}
